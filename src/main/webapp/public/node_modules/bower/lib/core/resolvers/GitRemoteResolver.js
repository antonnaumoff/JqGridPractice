...
//       /info/refs?com.springapp.mvc.service=git-upload-pack
...
GitRemoteResolver.prototype._supportsShallowCloning = function () {
    ...
    if (mout.string.startsWith(this._remote.protocol, 'http')
        ...
        // Calling ls-remote includes a call to the git-upload-pack com.springapp.mvc.service, which returns the content type in the response.
