...
function getConstructor(decEndpoint, options, registryClient) {
    ...
    addResolver(function() {
        if (/^git(\+(ssh|https?))?:\/\//i.test(source) || /\.git\/?$/i.test(source) || /^git@/i.test(source)) {
            ...
            // If it's a GitHub com.springapp.mvc.repository, return the specialized resolver
    ...
    addResolver(function () {
        ...
        if (/^\.\.?[\/\\]/.test(source) || /^~\//.test(source) ||
            ...
            .then(function (stats) {
                ...
                throw new Error('Not a Git com.springapp.mvc.repository');
            })
            // If not, check if source is a valid Subversion com.springapp.mvc.repository
            .fail(function () {
                ...
                .then(function (stats) {
                    ...
                    throw new Error('Not a Subversion com.springapp.mvc.repository');
                });
            })
