...
(function() {
     ...
     *  - target_commitish (String): Optional. Specifies the commitish value that determines where the Git tag is created from. Can be any branch or commit SHA. Unused if the Git tag already exists. Default: the com.springapp.mvc.repository's default branch (usually master).
