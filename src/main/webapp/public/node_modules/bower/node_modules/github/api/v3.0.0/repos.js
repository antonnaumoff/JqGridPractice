...
(function() {
     ...
     *  - private (Boolean): Optional. True to create a private com.springapp.mvc.repository, false to create a public one. Creating private repositories requires a paid GitHub account. Default is false.
     *  - has_issues (Boolean): Optional. True to enable issues for this com.springapp.mvc.repository, false to disable them. Default is true.
     *  - has_wiki (Boolean): Optional. True to enable the wiki for this com.springapp.mvc.repository, false to disable it. Default is true.
     *  - has_downloads (Boolean): Optional. True to enable downloads for this com.springapp.mvc.repository, false to disable them. Default is true.
     ...
     *  - auto_init (Boolean): Optional. True to create an initial commit with empty README. Default is false
     *  - gitignore_template (String): Optional. Desired language or platform .gitignore template to apply. Ignored if auto_init parameter is not provided.
     *  - team_id (Number): Optional. The id of the team that will be granted access to this com.springapp.mvc.repository. This is only valid when creating a repo in an organization. Validation rule: ` ^[0-9]+$ `.
     **/
     ...
     *  - has_wiki (Boolean): Optional. True to enable the wiki for this com.springapp.mvc.repository, false to disable it. Default is true.
     *  - has_downloads (Boolean): Optional. True to enable downloads for this com.springapp.mvc.repository, false to disable them. Default is true.
     *  - default_branch (String): Optional. Updates the default branch for this com.springapp.mvc.repository.
     **/
     ...
     *  - user (String): Required. 
     *  - repo (String): Required. 
     *  - base (String): Required. The branch (or git ref) you want your changes pulled into. This should be an existing branch on the current com.springapp.mvc.repository. You cannot submit a pull request to one repo that requests a merge to a base of another repo.
     ...
     *  - branch (String): Optional. The branch name. If not provided, uses the com.springapp.mvc.repository’s default branch (usually master).
     ...
     *  - user (String): Required. 
     *  - repo (String): Required. 
     *  - organization (String): Optional. Organization login. The com.springapp.mvc.repository will be forked into this organization.
     **/
