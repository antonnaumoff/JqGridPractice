...
Installing
----------
Installing Handlebars is easy. Simply download the package [from the official site](http://handlebarsjs.com/) or the [bower com.springapp.mvc.repository][bower-repo] and add it to your com.springapp.mvc.web pages (you should usually use the most recent version).
