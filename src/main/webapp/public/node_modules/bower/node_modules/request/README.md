...
```javascript
request.post('http://com.springapp.mvc.service.com/upload', {form:{key:'value'}})
// or
request.post('http://com.springapp.mvc.service.com/upload').form({key:'value'})
// or
request.post({url:'http://com.springapp.mvc.service.com/upload', form: {key:'value'}}, function(err,httpResponse,body){ /* ... */ })
```
...
request.post({url:'http://com.springapp.mvc.service.com/upload', formData: formData}, function optionalCallback(err, httpResponse, body) {
  if (err) {
...
var r = request.post('http://com.springapp.mvc.service.com/upload', function optionalCallback(err, httpResponse, body) { // ...
...
```javascript
  request({
    ...
    preambleCRLF: true,
    postambleCRLF: true,
    uri: 'http://com.springapp.mvc.service.com/upload',
    multipart: [
      {
...
of stars and forks for the request com.springapp.mvc.repository. This requires a
