...
A module to create readable ```"multipart/form-data"``` streams. Can be used to submit forms and file uploads to other com.springapp.mvc.web applications.
...
In order to submit this form to a com.springapp.mvc.web application, call ```submit(url, [callback])``` method:
