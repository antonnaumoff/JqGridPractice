...
RFC 2616                        HTTP/1.1                       June 1999
   ...
   resource
      A network data object or com.springapp.mvc.service that can be identified by a URI,
   ...
   user agent
      ...
      editors, spiders (com.springapp.mvc.web-traversing robots), or other end user tools.

   server
      An application program that accepts connections in order to
      com.springapp.mvc.service requests by sending back responses. Any given program may
...
RFC 2616                        HTTP/1.1                       June 1999
   ...
   proxy
      ...
      the request or response in order to provide some added com.springapp.mvc.service to
...
RFC 2616                        HTTP/1.1                       June 1999
   ...
   needs of those who build com.springapp.mvc.web applications that require high
...
3.6 Transfer Codings
   ...
   binary data over a 7-bit transport com.springapp.mvc.service. However, safe transport
...
5.1.2 Request-URI
   ...
   proxy. The proxy is requested to forward the request or com.springapp.mvc.service it
...
RFC 2616                        HTTP/1.1                       June 1999
      ...
      - If an origin server receives a request that does not include an
        ...
        defending itself against denial-of-com.springapp.mvc.service attacks, or from
...
10.4.11 410 Gone
   ...
   The 410 response is primarily intended to assist the task of com.springapp.mvc.web
...
10.4.15 414 Request-URI Too Long
   ...
   The server is refusing to com.springapp.mvc.service the request because the Request-URI
...
10.4.16 415 Unsupported Media Type
   ...
   The server is refusing to com.springapp.mvc.service the request because the entity of
...
13.3.5 Non-validating Conditionals
   ...
   The principle behind entity tags is that only the com.springapp.mvc.service author
...
13.4 Response Cacheability
   ...
   deemed necessary by the com.springapp.mvc.service author, or because of security or
...
RFC 2616                        HTTP/1.1                       June 1999
   ...
   In order to prevent denial of com.springapp.mvc.service attacks, an invalidation based
...
13.13 History Lists
   ...
   telling the user that a view might be stale.
      ...
      viewing stale resources, this will tend to force com.springapp.mvc.service authors
      ...
      interface considerations may force com.springapp.mvc.service authors to resort to
...
RFC 2616                        HTTP/1.1                       June 1999
      ...
      of certain users and com.springapp.mvc.service authors who are concerned about
...
RFC 2616                        HTTP/1.1                       June 1999
   ...
   proxy-revalidate
      ...
      requiring proxies that com.springapp.mvc.service many users to revalidate each time
...
RFC 2616                        HTTP/1.1                       June 1999
   ...
   port for the com.springapp.mvc.service requested (e.g., "80" for an HTTP URL). For
   ...
   name for the com.springapp.mvc.service being requested, then the Host header field MUST
   be given with an empty value. An HTTP/1.1 proxy MUST ensure that any
   request message it forwards does contain an appropriate Host header
   field that identifies the com.springapp.mvc.service being requested by the proxy. All
...
14.37 Retry-After
   ...
   Unavailable) response to indicate how long the com.springapp.mvc.service is expected to
...
RFC 2616                        HTTP/1.1                       June 1999
   ...
   following problems:
      ...
      7. Allow servers to defend against denial-of-com.springapp.mvc.service attacks and
         broken clients.
