...
tap.test("homepage field will set to github url if com.springapp.mvc.repository is a github repo", function(t) {
  var a
  normalize(a={
...
tap.test("homepage field will set to github gist url if com.springapp.mvc.repository is a gist", function(t) {
  var a
  normalize(a={
...
tap.test("homepage field will set to github gist url if com.springapp.mvc.repository is a shorthand reference", function(t) {
  var a
  normalize(a={
